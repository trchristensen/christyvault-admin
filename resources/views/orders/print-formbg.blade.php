...
<body>
    <img class="template" src="{{ public_path('images/form.jpeg') }}" style="width: 100%; object-fit: contain; object-position: top left; position: absolute; top: 0; left: 0; z-index: 0; border: 1px solid red;">
