                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <div>
                            <label class="block font-medium text-gray-700">
                                ...
                                <!-- add unit of measure next to input -->
                                 <div class="flex justify-between gap-2">
                                    <input type="number" name="remaining_quantity" step="0.01"
                                        class="block w-full px-3 py-2 mt-1 border border-gray-300 max-w-[100px] rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
