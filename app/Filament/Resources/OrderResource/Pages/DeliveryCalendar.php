...
class DeliveryCalendar extends Page
{
    ...
    {
        $createDeliveryTrip = Action::make('createSplitLoad')
            ->label('Plan delivery trip')
            ->icon('heroicon-o-truck')
            ->color('gray')
            ->size('lg')
            ->hiddenLabel()
            ->tooltip('Plan delivery trip')
        ...
        $createOrder = CreateAction::make('createOrder')
            ->label('Create order')
        ...
        $printCalendar = Action::make('Print Calendar')
