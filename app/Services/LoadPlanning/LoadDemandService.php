...
class LoadDemandService
{
    ...
    private function buildItem(
        ...
        $base = [
            ...
            'preferred_rack_level' => $product?->loadingProfile?->preferred_rack_level,
            ...
            'flatbed_fallback_units_per_pallet' => $product?->loadingProfile?->flatbed_fallback_units_per_pallet,
